(self.webpackChunk_frontend_evo_r2_ = self.webpackChunk_frontend_evo_r2_ || []).push([[41748], {
    157088: (e, n) => {
        var t;
        (function () {
            "use strict";
            ...
            o.prototype = {
                ...
                mute: function (e) {
                    ...
                    n.ctx || c(),
                        n._muted = e,
                        n.usingWebAudio && n.masterGain.gain.setValueAtTime(e ? 0 : n._volume, r.ctx.currentTime);
                    for (var t = 0; t < n._howls.length; t++)
                        if (!n._howls[t]._webAudio)
                            for (var o = n._howls[t]._getSoundIds(), a = 0; a < o.length; a++) {
                                var i = n._howls[t]._soundById(o[a]);
                ...
                stop: function () {
                    for (var e = this || r, n = 0; n < e._howls.length; n++)
                        e._howls[n].stop();
                    return e
                },
                unload: function () {
                    for (var e = this || r, n = e._howls.length - 1; n >= 0; n--)
                        e._howls[n].unload();
            ...
            a.prototype = {
                    ...
                    if (r.noAudio)
                        ...
                        for (var t = 0; t < e._src.length; t++) {
                            ...
                            if (e._format && e._format[t])
                                ...
                                (o = /^data:audio\/([^;,]+);/i.exec(a)) || (o = /\.([^.]+)$/.exec(a.split("?", 1)[0])),
                                    o && (o = o[1].toLowerCase())
                            }
                        ...
                        if (t._webAudio) {
                            var v = function () {
                                ...
                                m.gain.setValueAtTime(e, r.ctx.currentTime),
                                    ...
                                    void 0 === m.bufferSource.start ? u._loop ? m.bufferSource.noteGrainOn(0, s, 86400) : m.bufferSource.noteGrainOn(0, s, _) : u._loop ? m.bufferSource.start(0, s, 86400) : m.bufferSource.start(0, s, _),
                            ...
                            "running" === r.state && "interrupted" !== r.ctx.state ? v() : (t._playLock = !0,
                                t.once("resume", v),
                                t._clearTimer(u._id))
                        } else {
                            var h = function () {
                            ...
                            if (m.readyState >= 3 || A)
                                ...
                                var y = function () {
                                    h(),
                                        m.removeEventListener(r._canPlayEvent, y, !1)
                                };
                                m.addEventListener(r._canPlayEvent, y, !1),
                                    t._clearTimer(u._id)
                            }
                        }
                        return u._id
                ...
                mute: function (e, n) {
                    ...
                    for (var o = t._getSoundIds(n), a = 0; a < o.length; a++) {
                        ...
                        i && (i._muted = e,
                            ...
                            t._webAudio && i._node ? i._node.gain.setValueAtTime(e ? 0 : i._volume, r.ctx.currentTime) : i._node && (i._node.muted = !!r._muted || e),
                            t._emit("mute", i._id))
                    }
                    return t
                },
                volume: function () {
                    var e, n, t, o = this, a = arguments;
                    if (0 === a.length)
                        return o._volume;
                    if (1 === a.length || 2 === a.length && void 0 === a[1] ? o._getSoundIds().indexOf(a[0]) >= 0 ? n = parseInt(a[0], 10) : e = parseFloat(a[0]) : a.length >= 2 && (e = parseFloat(a[0]),
                        n = parseInt(a[1], 10)),
                        !(void 0 !== e && e >= 0 && e <= 1))
                    ...
                    for (var i = 0; i < n.length; i++)
                        (t = o._soundById(n[i])) && (t._volume = e,
                            a[2] || o._stopFade(n[i]),
                            o._webAudio && t._node && !t._muted ? t._node.gain.setValueAtTime(e, r.ctx.currentTime) : t._node && !t._muted && (t._node.volume = e * r.volume()),
                ...
                _stopFade: function (e) {
                    var n = this
                        , t = n._soundById(e);
                    return t && t._interval && (n._webAudio && t._node.gain.cancelScheduledValues(r.ctx.currentTime),
                ...
                rate: function () {
                    var e, n, t, o = this, a = arguments;
                    if (0 === a.length ? n = o._sounds[0]._id : 1 === a.length ? o._getSoundIds().indexOf(a[0]) >= 0 ? n = parseInt(a[0], 10) : e = parseFloat(a[0]) : 2 === a.length && (e = parseFloat(a[0]),
                        n = parseInt(a[1], 10)),
                        "number" != typeof e)
                    ...
                    for (var i = 0; i < n.length; i++)
                        if (t = o._soundById(n[i])) {
                            o.playing(n[i]) && (t._rateSeek = o.seek(n[i]),
                                t._playStart = o._webAudio ? r.ctx.currentTime : t._playStart),
                                t._rate = e,
                                o._webAudio && t._node && t._node.bufferSource ? t._node.bufferSource.playbackRate.setValueAtTime(e, r.ctx.currentTime) : t._node && (t._node.playbackRate = e);
                            var u = o.seek(n[i])
                ...
                seek: function () {
                    ...
                    if (0 === o.length ? n = t._sounds[0]._id : 1 === o.length ? t._getSoundIds().indexOf(o[0]) >= 0 ? n = parseInt(o[0], 10) : t._sounds.length && (n = t._sounds[0]._id,
            ...
            i.prototype = {
                ...
                create: function () {
                    ...
                    return n._webAudio ? (e._node = void 0 === r.ctx.createGain ? r.ctx.createGainNode() : r.ctx.createGain(),
            ...
            var u = {}
                , d = function (e) {
                    var n = e._src;
                    if (u[n])
                        return e._duration = u[n].duration,
                            void l(e);
                ...
                , _ = function (e, n) {
                    var t = function () {
                        ...
                        , o = function (e) {
                            e && n._sounds.length > 0 ? (u[n._src] = e,
                                l(n, e)) : t()
                        };
                    "undefined" != typeof Promise && 1 === r.ctx.decodeAudioData.length ? r.ctx.decodeAudioData(e).then(o).catch(t) : r.ctx.decodeAudioData(e, o, t)
                }
                , l = function (e, n) {
            ...
            void 0 === (t = function () {
                ...
                n.Howler = r,
                n.Howl = a,
                ("undefined" != typeof window || "undefined" != typeof window) && (window.HowlerGlobal = o,
                    window.Howler = r,
                    window.Howl = a,
                    window.Sound = i)
        }
...
//# sourceMappingURL=https://sourcemaps.egcdn.com/frontend/evo/r2/js/sm.howler.63e5e9ad.js.map
